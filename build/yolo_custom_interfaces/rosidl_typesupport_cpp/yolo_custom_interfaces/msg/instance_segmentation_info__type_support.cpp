...
static const _InstanceSegmentationInfo_type_support_symbol_names_t _InstanceSegmentationInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_custom_interfaces, msg, InstanceSegmentationInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolo_custom_interfaces, msg, InstanceSegmentationInfo)),
  }
};
...
{
  return &::yolo_custom_interfaces::msg::rosidl_typesupport_cpp::InstanceSegmentationInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolo_custom_interfaces, msg, InstanceSegmentationInfo)() {
  return get_message_type_support_handle<yolo_custom_interfaces::msg::InstanceSegmentationInfo>();
}
