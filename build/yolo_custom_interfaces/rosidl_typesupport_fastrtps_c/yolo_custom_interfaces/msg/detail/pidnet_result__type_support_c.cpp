...
#include "yolo_custom_interfaces/msg/detail/pidnet_result__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/image__functions.h"  // segmentation_map
...
using _PidnetResult__ros_msg_type = yolo_custom_interfaces__msg__PidnetResult;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PidnetResult__ros_msg_type * ros_message = static_cast<const _PidnetResult__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: segmentation_map
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->segmentation_map, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _PidnetResult__ros_msg_type * ros_message = static_cast<_PidnetResult__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _PidnetResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolo_custom_interfaces__msg__PidnetResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolo_custom_interfaces__msg__PidnetResult;
    is_plain =
      (
...
static size_t _PidnetResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yolo_custom_interfaces__msg__PidnetResult(
...
static message_type_support_callbacks_t __callbacks_PidnetResult = {
...
static rosidl_message_type_support_t _PidnetResult__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PidnetResult,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_custom_interfaces, msg, PidnetResult)() {
  return &_PidnetResult__type_support;
}
