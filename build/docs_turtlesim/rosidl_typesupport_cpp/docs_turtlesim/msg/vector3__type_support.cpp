...
static const _Vector3_type_support_symbol_names_t _Vector3_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, docs_turtlesim, msg, Vector3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, docs_turtlesim, msg, Vector3)),
  }
};
...
{
  return &::docs_turtlesim::msg::rosidl_typesupport_cpp::Vector3_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, docs_turtlesim, msg, Vector3)() {
  return get_message_type_support_handle<docs_turtlesim::msg::Vector3>();
}
