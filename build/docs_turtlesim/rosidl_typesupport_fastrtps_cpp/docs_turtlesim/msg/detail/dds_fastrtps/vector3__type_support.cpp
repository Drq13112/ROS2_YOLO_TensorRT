...
#include "docs_turtlesim/msg/detail/vector3__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const docs_turtlesim::msg::Vector3 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  docs_turtlesim::msg::Vector3 & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = docs_turtlesim::msg::Vector3;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const docs_turtlesim::msg::Vector3 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<docs_turtlesim::msg::Vector3 *>(
    untyped_ros_message);
...
{
  return &docs_turtlesim::msg::typesupport_fastrtps_cpp::_Vector3__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, docs_turtlesim, msg, Vector3)() {
  return &docs_turtlesim::msg::typesupport_fastrtps_cpp::_Vector3__handle;
}
