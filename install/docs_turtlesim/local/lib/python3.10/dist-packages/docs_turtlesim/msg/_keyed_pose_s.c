...
bool docs_turtlesim__msg__keyed_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("docs_turtlesim.msg._keyed_pose.KeyedPose", full_classname_dest, 40) == 0);
  }
  docs_turtlesim__msg__KeyedPose * ros_message = _ros_message;
  {  // turtle_id
...
{
  /* NOTE(esteve): Call constructor of KeyedPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("docs_turtlesim.msg._keyed_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyedPose");
