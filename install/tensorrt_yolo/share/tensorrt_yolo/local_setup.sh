...
: ${AMENT_CURRENT_PREFIX:="/home/david/yolocpp_ws/install/tensorrt_yolo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tensorrt_yolo/environment/pythonpath.sh"
